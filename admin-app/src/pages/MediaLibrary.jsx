...
const MediaLibrary = () => {
 ...
 <label className="flex items-center gap-2 bg-red-600 text-white px-6 py-3 rounded-xl hover:bg-red-700 transition-colors font-bold cursor-pointer shadow-lg hover:shadow-red-600/30">
 <Upload size={20} />

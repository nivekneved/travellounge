    ...
    return (
        <div className="max-w-4xl space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4 md:col-span-2">
                    ...
                    <div className="flex items-center gap-8 mb-6">
                        <div className="flex-grow">
                            ...
                            <p className="text-sm text-gray-500 ">Mauritius DPA 2017 recommends minimal retention. Default is 12.</p>
                        </div>
                        <input
                            type="number"
                ...
                <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 text-white shadow-xl md:col-span-2 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -mr-16 -mt-16 blur-3xl"></div>
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h3 className="text-2xl font-black mb-1">Infrastructure Health</h3>
                            <p className="text-slate-400 font-medium text-sm">Real-time status of critical system anchors</p>
                        </div>
                        <div className="flex items-center gap-2 px-3 py-1 bg-green-500/10 rounded-lg border border-green-500/20">
                            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                            <span className="text-[10px] font-black text-green-500 uppercase tracking-widest">Global Reach Stable</span>
                        </div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl backdrop-blur-md border border-white/5">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-primary-500/20 rounded-lg text-primary-400">
                                    <Activity size={18} />
                                </div>
                                <span className="font-bold text-xs uppercase tracking-widest">Main API Gateway</span>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl backdrop-blur-md border border-white/5">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-bold text-xs uppercase tracking-widest">Supabase Auth</span>
                            </div>
                            <span className="w-2.5 h-2.5 bg-green-400 rounded-full shadow-[0_0_10px_rgba(74,222,128,0.5)]"></span>
                        </div>
                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl backdrop-blur-md border border-white/5">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-bold text-xs uppercase tracking-widest">Edge Workers</span>
                            </div>
                            <span className="w-2.5 h-2.5 bg-green-400 rounded-full shadow-[0_0_10px_rgba(74,222,128,0.5)]"></span>
                        </div>
                    </div>
